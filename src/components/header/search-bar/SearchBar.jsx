        ...
        <div>
            {
                isInputActive ?
                    ...
                    <label
                        className={`input flex items-center font-normal focus-within:border_style hover:border_style gap-2 bg-[#2e313e] cursor-pointer`}>
                        <input
                            value={inputValue}
                            onFocus={onFocusHandler}
                            onChange={onUserSearchHandler}
            ...
            <AnimatePresence>
                {openDestInputModal && (
                    ...
                    >
                        ...
                        <div
                            className={`flex ${filteredCities.length === 1 ? "items-center" : "items-start"} flex-col pt-[13px] gap-2 max-h-[12rem] ${visibleItemsCount > 3 && "overflow-y-scroll"}`}>
